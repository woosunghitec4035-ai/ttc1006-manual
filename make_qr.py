...
제품 매뉴얼 QR코드 생성기
사용법:
    python make_qr.py "https://실제주소/" "TTC-50"

- 오류정정 레벨 H(30%) : 중앙에 로고/라벨을 넣어도 인식 가능
- 우성하이텍 레드 색상 적용
- 출력: qr_<라벨>.png (300dpi 인쇄용). 라벨의 하이픈·공백은 제거됩니다.
"""
import sys
import qrcode
...
URL = sys.argv[1] if len(sys.argv) > 1 else "https://example.com/wsm4035/"
LABEL = sys.argv[2] if len(sys.argv) > 2 else "WSM-4035"
